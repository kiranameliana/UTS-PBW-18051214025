...
include_once 'oop/objects/category.php';
include_once 'oop/objects/mitra.php';
...
$mitra = new mitra($db);
// set page headers
$page_title = "Daftar Jadi Mitra Kami!!";
include_once "oop/layout_header.php";
 
// contents will be here
 echo "<div class='right-button-margin'>";
    echo "<a href='index.html' class='btn btn-danger pull-right'>Kembali</a>";
echo "</div> </br>";
